            ...
            <form action="#" method="GET" class="w-full md:w-auto">
                <div x-data="{ showModal: false }" class="relative flex items-center w-full">
                    ...
                    <input type="text" name="search" value="{{ $search }}"
                        ...
                        placeholder="Cari notulen..." autocomplete="off" autofocus />
            ...
            <table class="min-w-full bg-gray-100">
                <thead class="bg-gray-800 text-white">
                    <tr>
                        ...
                        <th class="text-left py-3 px-2 text-sm font-semibold uppercase">Masalah</th>
                        <th class="text-left py-3 px-2 text-sm font-semibold uppercase">Ditindaklanjuti Oleh</th>
                        <th class="text-center py-3 px-2 text-sm font-semibold uppercase">Batas Tindak Lanjut</th>
                    ...
                    @forelse ($minutes as $minute)
                        <tr class="border-t hover:bg-blue-100 transition duration-200">
                            ...
                            <td class="py-3 px-2 flex justify-center items-center gap-1">
                                <a href="{{ route('dashboard.minute.printPDF', $minute->id) }}" target="_blank"
                                ...
                                <a href="{{ route('dashboard.minute.edit', $minute->id) }}" aria-label="Edit Notulen"
                                ...
                                <form action="{{ route('dashboard.minute.destroy', $minute->id) }}" method="POST"
                                    class="flex items-center"
                                    onsubmit="return confirm('Yakin ingin menghapus notulen?');">
                                    @csrf
                                    @method('DELETE')
                                    <button aria-label="Hapus Notulen"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4">
                                <h3 class="font-medium text-red-500">Notulen tidak ditemukan</h3>
