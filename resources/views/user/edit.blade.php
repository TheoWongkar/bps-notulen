<x-app-layout>
    ...
    <section class="bg-white p-6 shadow-lg rounded-lg">
        <div class="border-b mb-6">
            <h2 class="text-xl font-semibold mb-2 text-black">Ubah Pengguna</h2>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="role" id="role"
                        ...
                        <option value="Notulis" {{ old('role', $user->role) == 'Notulis' ? 'selected' : '' }}>Notulis
                        </option>
                ...
                <div class="flex flex-col md:flex-row justify-center items-start gap-6">
                    <div class="w-full">
                        <label for="password" class="text-sm font-medium text-black">Password <span
                                class="text-gray-500">(biarkan kosong jika tidak diganti)</span></label>
                ...
                <div class="flex justify-end space-x-2 mt-4">
                    ...
                    <button type="submit" class="bg-blue-700 text-white py-2 px-6 rounded-md hover:bg-blue-800">
                        Perbarui
                    </button>
                </div>
            </div>
